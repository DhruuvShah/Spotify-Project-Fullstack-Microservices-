...
import { Play, Heart, ListMusic, MoreVertical, UserRound, Trash2, ChevronLeft } from "lucide-react";
...
export default function UserPlaylistDetail() {
  ...
  function removeSong(musicId) {
    axios
      .patch(
        `${MUSIC_URL}/api/music/user-playlist/${id}/remove/${musicId}`,
        {},
    ...
    <div className="pd-root">
      ...
      <div className="pd-hero">
        ...
        <div className="pd-hero-info">
          <p className="pd-type-label">My Playlist</p>
      ...
      <div className="pd-tracks">
        {musics.length === 0 ? (
          <p className="pd-empty">
            This playlist has no songs yet. Add songs from search or home!
          </p>
        ) : (
          <>
            ...
            {musics.map((track, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Context menu — includes Remove for this page */}
                  <div
...
function TrashIcon()            { return <Trash2       aria-hidden="true" />; }
